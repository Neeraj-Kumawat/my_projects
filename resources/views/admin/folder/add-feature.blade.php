        ...
        <div class="card-body">
            <form method="POST" action="{{ url('admin/feature-form') }}" enctype="multipart/form-data">
                @csrf
        <div class="row">
          ...
          <div class="page-header">
            <div class="row align-items-center">
            <div class="col">
            <h3 class="page-title">Feature Information </h3>
            </div>
            <div class="col-auto text-end float-end ms-auto download-grp">
            <a href="{{url('admin/feature-list')}}" class="btn btn-primary"><i class="fas fa-plus">𝐁𝐚𝐜𝐤</i></a>
            </div>
            </div>
            </div>
        ...
        <input name="title" class="form-control" type="text" placeholder="Enter Your Title Name">
