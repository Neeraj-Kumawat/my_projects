        ...
        <div class="card-body">
                ...
                <form method="POST" action="{{ url('admin/gallery-form') }}" enctype="multipart/form-data">
                        @csrf
        <div class="row">
          ...
          <div class="page-header">
            ...
            <a href="{{url('admin/gallery-list')}}" class="btn btn-primary"><i class="fas fa-plus">𝐁𝐚𝐜𝐤</i></a>
            </div>
            </div>
            </div>
