        ...
        <div class="card-body">
                <form method="POST" action="<?= url('admin/membership/update/'.$membership->id); ?>">
                        @csrf
        <div class="row">
        <div class="col-12">
        <h5 class="form-title student-info">Membership Information</h5>
                ...
                <div class="col-12 col-sm-4">
                        ...
                        <input name="title" value="{{$membership->title}}" class="form-control" type="text" placeholder="Enter Your Title">
                        ...
                        <div class="col-12 col-sm-4">
                                ...
                                <input name="year" value="{{$membership->year}}"  class="form-control" type="text" placeholder="Enter Your Year">
                                <span class="text-danger">
                                        @error('year')
                                        {{$message}}                                
                                        @enderror
        ...
        <div class="col-12 col-sm-12">
                ...
                placeholder="Hi, Do you have a moment to talk Joe?"
                 aria-label="Hi, Do you have a moment to talk Joe?"
                  aria-describedby="basic-icon-default-message2"> {{$membership->descripition}} </textarea>
                  <span class="text-danger">
                    @error('descripition')
                    {{$message}}                                
                    @enderror
