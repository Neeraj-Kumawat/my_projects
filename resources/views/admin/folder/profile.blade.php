...
<h4 class="user-name mb-0">{{$loggedInAdmin->username}}</h4>
<h6 class="text-muted">{{$loggedInAdmin->email}}</h6>
...
<a href="{{url('admin/register_edit/')}}/{{$loggedInAdmin->id}}" class="btn btn-primary">
Edit
</a>
</div>
</div>
...
<a href="{{url('admin/register_edit/')}}/{{$loggedInAdmin->id}}" class="btn btn-sm bg-danger-light"><i class="feather-edit"></i></a>
</h5>
<div class="row">
<p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Name</p>
<p class="col-sm-9">{{$loggedInAdmin->username}}</p>
</div>
{{-- <div class="row">
...
<p class="col-sm-9"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a1cbcec9cfc5cec4e1c4d9c0ccd1cdc48fc2cecc">{{$loggedInAdmin->email}}</a></p>
</div>
